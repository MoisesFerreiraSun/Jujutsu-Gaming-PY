...
#     def __init__(self, image_path, size=10):
#         """
#         Cria cada bloco com uma textura a partir de uma imagem.

#         image_path: caminho da imagem que será usada como textura.
#         size: tamanho de cada quadrado.
#         """
#         pygame.sprite.Sprite.__init__(self)
        
#         # Carregar a imagem da textura
#         self.image = pygame.image.load(DIRECTORY + "/images/block.png")
#         self.rect = self.image.get_rect()
    
#     def update(self):
#         """
#         Atualiza o bloco, se necessário.
#         """
#         pass
...
class Ship(pygame.sprite.Sprite):
    ...
    def __init__(self, path, pos_x, pos_y, speed = 5):
        ...
        self.__sound_shot = pygame.mixer.Sound(DIRECTORY + "/sounds/energy.mp3")
        self.__ship_explosion = pygame.mixer.Sound(DIRECTORY + "/sounds/explosao.mp3")
    ...
    def update(self, *args):
        ...
        # Se estiver pressionando o botão da seta da esquerda
            ...
            if self.rect.left > self.speed:
                self.rect.x -= self.speed
        # Se estiver pressionando o botão da tecla 'D'
        elif pygame.key.get_pressed()[pygame.K_d]:
            if self.rect.right < (SCREEN_WIDTH - self.speed):
                self.rect.x += self.speed
        # Se estiver pressionando o botão da tecla 'A'
...
class Invader(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        """
        bullet = BulletInimigo(self.rect.midtop, -1, speed = 4, color = RED)
        return bullet
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, pos_xy, direction, color=None, speed=10):
        """
        ...
        speed: velocidade que o objeto se deslocará.
                Por padrão é 50px.
        color: cor do objeto. 
                Por padrão é None, pois estamos usando uma imagem.
        """
        pygame.sprite.Sprite.__init__(self)
        
        # Carregando a imagem do tiro
        self.image = pygame.image.load(DIRECTORY + "/images/tiropadrao.png")
        self.image = pygame.transform.scale(self.image, (20, 50))  # Ajuste o tamanho conforme necessário
        self.rect = self.image.get_rect()
...
class BulletInimigo(pygame.sprite.Sprite):
    """
    Classe que representa as balas de todos os objetos que realizam disparos.
    """

    def __init__(self, pos_xy, direction, color=None, speed=5):
        """
        Constrói um objeto do tipo Bullet.
        ...
        # Carregando a imagem do tiro
        self.image = pygame.image.load(DIRECTORY + "/images/tiro.png")
        self.image = pygame.transform.scale(self.image, (20, 50))  # Ajuste o tamanho conforme necessário
        self.rect = self.image.get_rect()
        self.rect.x = pos_xy[0]
        self.rect.y = pos_xy[1]
...
class SpaceInvaders():
    ...
    def __init__(self):
        ...
        """
        self.background_music = DIRECTORY + "/sounds/menu.mp3"
        ...
        pygame.display.set_caption("JUJUTSU : GAMING")
        ...
        self.explosion_sound = pygame.mixer.Sound(DIRECTORY + "/sounds/explosao.mp3")
        
        # Carregando imagens necessárias
        self.path_image_ship = DIRECTORY + "/images/ship.png"
        background_image = pygame.image.load(DIRECTORY + "/images/back.jpg")
    ...
    def home_screen(self):
        ...
        text = self.font.render("JUJUTSU : GAMING", True, RED)
        self.font = self.create_font(20)
        command1 = self.font.render("ENTER : INICIAR ", True, RED, None)
        command2 = self.font.render("   ESC : SAIR      ", True, RED, None)
    ...
    def final_screen(self):
        ...
        text1 = self.font50.render("PONTUAÇÃO FINAL: %d" % self.score, True, RED)
        text2 = self.font20.render("CLIQUE NO ENTER PARA TENTAR NOVAMENTE", True, RED)
        text3 = self.font20.render("CLIQUE ESC PARA SAIR", True, RED)
    ...
    def level_screen(self):
        ...
        text = font.render('LEVEL: ' + str(self.level), True, RED)
    ...
    def update(self):
        ...
        """
        score = self.score_font.render("PONTUACAO: %d" % self.score, True, RED)
        ...
        self.groups = pygame.sprite.Group(self.ship, self.ship_shot, self.invader_shot, self.invaders, 
                                    self.left_edge, self.bottom_edge, self.right_edge)
        self.clock.tick(60)
        pygame.display.update()
